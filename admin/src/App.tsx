...
import { TickerIndex } from "./ticker/TickerIndex";
import { CompanyIndex } from "./company/CompanyIndex";
import { ZxcIndex } from "./zxc/ZxcIndex";
      ...
      <MainLayout.Content>
        ...
        <Page>
          <Switch>
            ...
            <PrivateRoute path="/tickers" component={TickerIndex} />
            <PrivateRoute path="/companies" component={CompanyIndex} />
            <PrivateRoute path="/zxcs" component={ZxcIndex} />
          </Switch>
        </Page>
      </MainLayout.Content>
    </>
